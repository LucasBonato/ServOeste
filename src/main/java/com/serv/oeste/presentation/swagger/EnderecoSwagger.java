...
public interface EnderecoSwagger extends SwaggerConfiguration {
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "404", description = "[NotFound] O Endereço informado não foi encontrado.", content = @Content(schema = @Schema(implementation = ExceptionResponse.class))),
