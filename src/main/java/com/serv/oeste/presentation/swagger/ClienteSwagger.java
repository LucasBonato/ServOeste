...
public interface ClienteSwagger extends SwaggerConfiguration{
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "404", description = "[NotFound] Cliente não foi encontrado.", content = @Content(schema = @Schema(implementation = DomainException.class))),
    })
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "400", description = "[BadRequest] Alguma informação foi passada de forma errada.", content = @Content(schema = @Schema(implementation = DomainException.class))),
            @ApiResponse(responseCode = "404", description = "[NotFound] O Cliente informado não foi encontrado.", content = @Content(schema = @Schema(implementation = DomainException.class))),
    })
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "400", description = "[BadRequest] Alguma informação foi passada de forma errada.", content = @Content(schema = @Schema(implementation = DomainException.class))),
            @ApiResponse(responseCode = "404", description = "[NotFound] Algum cliente informado não foi encontrado.", content = @Content(schema = @Schema(implementation = DomainException.class))),
    })
